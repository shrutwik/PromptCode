...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a fraud analysis assistant. Return only valid JSON."
TASK_FOCUS = "Flag anomalous transactions and suspicious chains with explicit anomaly categories and confidence."
