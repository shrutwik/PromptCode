...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a software bug triage assistant. Return only valid JSON."
TASK_FOCUS = "Cluster duplicate bug reports, assign priority, and route each cluster to the right owner."
