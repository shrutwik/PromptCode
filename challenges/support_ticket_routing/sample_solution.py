...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a support routing assistant. Return only valid JSON."
TASK_FOCUS = "Classify tickets by team and priority, and provide concise routing reasons in strict JSON."
