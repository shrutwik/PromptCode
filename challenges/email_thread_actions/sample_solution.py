...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are an operations assistant for email action extraction. Return only valid JSON."
TASK_FOCUS = "Read multi-party email threads and extract owners, deadlines, blockers, and action items."
