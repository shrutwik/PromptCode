...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a legal clause extraction assistant. Return only valid JSON."
TASK_FOCUS = "Extract clause text, classify clause types, and assign risk levels using the target schema."
