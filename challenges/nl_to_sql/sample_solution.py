...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a careful analytics assistant. Return only valid JSON."
TASK_FOCUS = "Translate the natural-language question into the expected SQL output using schema and constraint hints."
