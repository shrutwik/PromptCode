...
MODEL = "gpt-4o-mini"
SYSTEM_PROMPT = "You are a legacy API migration assistant. Return only valid JSON."
TASK_FOCUS = "Transform XML-like legacy payloads into the target JSON schema and preserve unmapped data explicitly."
